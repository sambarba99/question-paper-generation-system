...
public final class Constants {
	 ...
	 * File path constants
	 */
	public static final String QUESTIONS_FILE_PATH = "C:\\#QPGS\\questions.xml";

	public static final String QUESTION_PAPERS_FILE_PATH = "C:\\#QPGS\\questionpapers.xml";

	public static final String SUBJECTS_FILE_PATH = "C:\\#QPGS\\subjects.xml";

	public static final String USERS_FILE_PATH = "C:\\#QPGS\\users.xml";
	...
	/**
	 * Subject and question paper titles must be only alphanumeric characters, and no repeating
	 * spaces.
	 */
	public static final String TITLE_REGEX = "^(\\w\\s?)+$";

	/**
	 * Username must start with letter(s) and optionally have a number at the end, in case the same
	 * username exists already and can be made unique.
	 */
	...
	public static final String SURE_TO_EXIT = "Are you sure you wish to exit QPGS?\nAny changes have been saved.";
