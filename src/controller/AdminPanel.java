...
public class AdminPanel {
    ...
    public static void display(User currentUser) {
        ...
        Button btnOpenAcademicMaterial = new ButtonBuilder()
            ...
            .build();
        Button btnUpdatePassword = new ButtonBuilder()
            .withWidth(200)
        ...
        VBox vboxUsersView = (VBox) new PaneBuilder()
            .withBoxType(BoxType.VBOX)
            .withAlignment(Pos.CENTER)
            .withSpacing(10)
            .withNodes(lblUsers, tblUsers)
            .build();
        VBox vboxActions = (VBox) new PaneBuilder()
            .withBoxType(BoxType.VBOX)
            .withAlignment(Pos.CENTER)
            .withSpacing(10)
            ...
            .build();
        HBox hboxViewAndActions = (HBox) new PaneBuilder()
