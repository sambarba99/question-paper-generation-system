...
public class RawQuestionTransformer {
    ...
    /**
     * Loop through subjects and add them to subjects CSV file, and write questions for each subject
        ...
        for (Entry<String, List<String>> entry : questionsAndAnswers.entrySet()) {
            ...
            for (String answerStr : answersStr) {
                ...
                answers.add(new AnswerBuilder()
                    .withValue(answerStr)
                    .withIsCorrect(answerStr.charAt(0) == '1')
                    .build());
            }
             ...
             * determining of how good a question paper is after it is generated.
             */
