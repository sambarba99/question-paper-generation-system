 ...
 * @author Sam Barba
 */
public class ViewQuestionPaper extends UIController {
	...
	public static void display(QuestionPaper questionPaper) {
		...
		txtAreaPaper.setText(questionPaperService.getQuestionPaperDisplayStr(questionPaper));
		...
		Button btnExport = new ButtonBuilder()
			...
			.withActionEvent(e -> {
				if ("C:\\".equals(destinationDir)) {
					...
					boolean success = questionPaperService.exportToTxt(questionPaper, destinationDir);
					if (success) {
