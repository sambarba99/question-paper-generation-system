...
public class QuestionDAO {
        ...
        try {
            ...
            if (csvFile.exists()) {
                ...
                while (input.hasNextLine()) {
                    ...
                    LocalDateTime dateCreated = LocalDateTime.parse(lineArr[11]
                        .replace(Constants.QUOT_MARK, Constants.EMPTY), Constants.DATE_FORMATTER);

                    questions.add(new QuestionBuilder()
                        .withId(id)
    ...
    private void addQuestionDataToFile(Question question, FileWriter writer, boolean append) throws IOException {
        ...
        /*
         * 1 line contains: ID, subject ID, statement, answers A-D, correct answer letter (A/B/C/D),
         * skill level, marks, minutes required, date created
         */
    ...
    /**
     * Make answers for a question, given a list of possible answers and the letter of the correct
     * one.
     * 
    ...
    private List<Answer> makeAnswers(List<String> answersStr, String correctAnswerLetter) {
        /*
         * Since correct answer is A-D, the ASCII value of 'A' is subtracted to get its position in
         * the list of answers. E.g. If C is correct, then position in list = 67 - 65 = 2.
         */
