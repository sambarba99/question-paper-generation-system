...
public class Login extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        /*
         * If this is first-time system access, the first user needs to be created, and questions
         * and subjects CSV files (for demo purposes)
         */
                ...
                switch (userPrivilege) {
                    ...
                    default:
                        SystemNotification.display(SystemNotificationType.ERROR,
                            Constants.UNEXPECTED_ERROR + "Invalid User Privilege passed: "
                                + userPrivilege.toString());
